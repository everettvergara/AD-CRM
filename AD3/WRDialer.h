...
namespace eg::ad3
{
	...
	public:
		...
		WRDialer(wxMDIParentFrame* parent, const char* title, size_t account_ix);
	...
	protected:
		...
		wxTextCtrl* filter_wav_filename_;
		...
		void on_choose_wav_(wxCommandEvent&);
